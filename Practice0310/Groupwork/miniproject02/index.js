...
let optionBase, optionTarget;
const selectTarget = document.querySelector("#target-currency");
const result = document.querySelector("#conversion-result");

function Kevin()
{
  let MyWrapper = new FetchWrapper("https://v6.exchangerate-api.com/v6/2700f6dbaf7a1a2ac1bed9cc/pair/");
}

selectBase.addEventListener("change", function()
{
  optionBase = selectBase.options[selectBase.selectedIndex].text;
});
